...
for deal in sorted_deals:
    ...
    new_deals_details += (
        f"Name: {deal_name}, Amount: {amount}, Deal Owner: {deal_owner}, "
        f"Deal Source 1: {deal_source_1}, Deal Source 2: {deal_source_2}, "
        f"Created Date: {created_date}\n"
    )

# Combine all parts of the report
final_report = f"{report_header}\n{summary}\n{new_deals_details.strip()}"

# Send to Slack
send_to_slack_formatted(final_report)
